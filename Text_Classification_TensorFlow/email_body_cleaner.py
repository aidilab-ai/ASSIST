...
def clean_email_body(raw_email_body):
    ...
    decoded_email_body = regex_utf8_hex_values.sub(repl=lambda match: convert_to_unicode( match.group() ), string=raw_email_body)
